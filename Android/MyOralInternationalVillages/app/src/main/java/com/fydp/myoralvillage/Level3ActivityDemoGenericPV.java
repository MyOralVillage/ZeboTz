...
public class Level3ActivityDemoGenericPV extends GenericActivityGame {
    ...
    public void startDemo(){
        ...
        /*
        final ImageView pa_anga_5 = (ImageView) findViewById(R.id.paanga5);
        final ImageView pa_anga_50_senti = (ImageView) findViewById(R.id.paanga50senti);
        final ImageView pa_anga_50_senti_Snap = (ImageView) findViewById(R.id.paanga50sentiSnap);
        final ImageView pa_anga_5_Snap = (ImageView) findViewById(R.id.paanga5Snap);
        */
        ...
        currencies[first_bill].bill.startAnimation(firstAnimationSet);
        firstAnimationSet.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                // How does snap work?
                currencies[first_bill].snap.setBackgroundResource(currencies[first_bill].drawable_id);
                cashView.setText(String.format(locale,format_string, currencies[first_bill].value));
            }
        });
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                final ImageView imagefinger = new ImageView(Level3ActivityDemoGenericPV.this);
                ...
                currencies[second_bill].bill.startAnimation(secondAnimationSet);
                secondAnimationSet.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        // TODO Auto-generated method stub
                        //img_animation1.layout(1500,400,1500,1000);
                        currencies[second_bill].snap.setBackgroundResource(currencies[second_bill].drawable_id);
                        imagefinger.setVisibility(View.INVISIBLE);
                        cashView.setText(String.format(locale,format_string, currencies[first_bill].value+currencies[second_bill].value));
                    }
                });
            }
        }, 3400);
